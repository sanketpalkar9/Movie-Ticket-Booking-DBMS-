...
app.get("/locationDetails", (req, res) => {
  sql = "SELECT location_details, name FROM theatre";
...
app.post("/adminMovieAdd", (req, res) => {
  ...
  const sql1 = `Insert into movie (name,image_path,language,description,rating,duration,top_cast,release_date)
  values
  (?,?,?,?,?,?,?,?)`;
...
app.post("/adminLatestShowDates", (req, res) => {
...
// For local usage
app.listen(7000, () => {
  console.log("Now, it is listening on port 7000");
});
